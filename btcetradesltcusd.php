<?php 
//BTC-E TRADES
$jsonbtcetrades = file_get_contents('https://btc-e.com/api/3/trades/ltc_usd');
$decodedbtcet = json_decode($jsonbtcetrades);
$btcetrades1 = $decodedbtcet->ltc_usd;

// Store cache  
file_put_contents('tradesltcusd.json', serialize($btcetrades1));  
// Retrieve cache  
$btcetrades1 = unserialize(file_get_contents('tradesltcusd.json'));
...
echo "$ln2<span class=\"bigtitle\" >BTC-E LITECOIN/USD</span><br>";
